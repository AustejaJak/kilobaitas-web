...
export default function BackgroundComponent() {
    return (
        <>
            ...
            <img src={BackgroundLightRed} alt="Background Light Red" className="absolute opacity-20 right-0 top-0 w-1/2 h-full object-cover z-2"/>
            <img src={BackgroundLightBlue} alt="Background Light Blue" className="absolute opacity-20 left-0 top-0 w-1/2 h-full object-cover z-2"/>
